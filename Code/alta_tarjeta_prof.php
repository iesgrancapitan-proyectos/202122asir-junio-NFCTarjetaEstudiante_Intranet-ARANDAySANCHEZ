        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    ...
                    <h2 id="letra2" class="mx-auto mt-2 mb-5 letradedia">Pasa la tarjeta o escribe tu codigo de profesor
                    </h2>
                    ...
                    <form id="acceso" method='POST' action='alta_tarjeta_prof.php'>
                        <input type="text" name="idtarjeta"><br><br>
                        <a class="btn btn-primary" href="alta_prof.php">Volver</a>
                        <input type="submit" class="btn btn-primary" value="Alta Tarjeta" name="acceder">
                    </form>
                ...
                if (isset($_REQUEST['acceder'])){
                    ...
                    $nie2 = $_SESSION['usuario'];
                    
                    $queryusuario = mysqli_query($conn,"SELECT * FROM tabla_nfc_tarjeta WHERE idtarjeta = '$idtarjeta'");
                    $nr 		= mysqli_num_rows($queryusuario); 
                    $mostrar	= mysqli_fetch_assoc($queryusuario); 

                    if (($nr >= 1)){
                        echo "La tarjeta ya se encuentra en la base de datos";
                    } else {
                        $insertar = "INSERT INTO tabla_nfc_tarjeta (IdTarjeta, Activo) VALUES ('$idtarjeta', 'si')";
                        $result = mysqli_query($conn,$insertar); 
                        
                        header("Location: alta_prof.php");
                    
                    }

                        $actualizar = "UPDATE tabla_nfc_profesores SET idtarjeta = '$idtarjeta' WHERE usuario = '$nie2'";
