        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    <h1 id="letra" class="mx-auto my-0 text-uppercase">Baja de Tarjeta</h1>
                   
                    <h2 id="letra2" class="mx-auto mt-2 mb-5 letradedia">Seleccione Unidad
                    </h2>
                    <form method="POST" action="listausers_baja.php">
                    ...
                    while($row= mysqli_fetch_array($result)){
                        ...
                        echo "<option name='unidades' value=".$row['unidades'].">".$row['unidades']."</option>";

                    }
                    
                    ?>
                    </select>
                    <a class="btn btn-primary" href="menu_baja.php">Volver</a>
