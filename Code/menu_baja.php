        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    <h1 id="letra" class="mx-auto my-0 text-uppercase">Baja de Tarjetas</h1>

                    <h2 id="letra2" class="mx-auto mt-2 mb-5 letradedia">Clickea en el botón Profesores o Alumnos
                    </h2>
                    <a class="btn btn-primary" href="baja_profesores.php">Profesores</a>
                    <a class="btn btn-primary" href="baja_tarjeta.php">Alumnos</a>
