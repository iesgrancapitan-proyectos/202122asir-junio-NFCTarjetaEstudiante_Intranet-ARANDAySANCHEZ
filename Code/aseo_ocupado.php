...
<embed src="ocupado.mp3" autostart="true" loop="true" volume="80" width="0" height="0">
<body id="page" class="rojo">
        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    <h1 id="letra" class="mx-auto my-0 text-uppercase">Aseo Ocupado</h1>
                    <h2 id="letra2" class="mx-auto mt-2 mb-5"> Espere unos minutos para volver a intentarlo</h2>
