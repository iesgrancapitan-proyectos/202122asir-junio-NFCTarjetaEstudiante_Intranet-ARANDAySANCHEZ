...
<body id="page">
    ...
    <?php $unidad = $_POST['unidades']; ?>
    <h1 id="unidad"> Consultando la unidad <em style="color:#3B3B3A"><?php echo $unidad ?></em></h1>
            ...
            <div class="d-flex justify-content-center">
                ...
                <table id="divtabla" class="table table-striped">
                    ...
                    <tbody>
                        ...
                        $queryusuario = mysqli_query($conn,"SELECT idtarjeta FROM tabla_nfc_estudiantes where idtarjeta is NOT NULL and Unidad = '$unidad2'");
                        ...
                        if (isset($_REQUEST['Acceder'])){
                            ...
                            while($row= mysqli_fetch_array($result)){
                                if ($row['idtarjeta'] != NULL){
                                    echo "<tr> <td> <input type='radio' name='idtarjeta' required value=".$row['idtarjeta']."> ".$row['NIE']."</option> </td>" . " <td> ". $row['idtarjeta'] ." </td></th>";
                        ...
                        echo "<h1 class='form-control'style='color: red;'>No hay tarjetas en esta unidad asignadas</h1>";
                        header( "refresh:3;url=baja_tarjeta.php" );
                    }
                ...
                <a class="btn btn-primary" href="baja_tarjeta.php">Volver</a>
