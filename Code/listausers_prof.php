...
<body id="page">
    ...
    <?php $departamentos = $_POST['departamento']; ?>
    <h1 id="unidad"> Consultando <em style="color:grey"><?php echo $departamentos?> </em></h1>
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                ...
                <form method='POST' action='alta_tarjeta_prof.php'>
                <div id="divtabla"class="table-responsive">
                    <table class="table table-striped ">
                        ...
                        // Creamos la consulta
                            ...
                            $queryusuario = mysqli_query($conn,"SELECT idtarjeta FROM tabla_nfc_profesores where idtarjeta is NULL and departamento = '$departamentos'");
                            ...
                            if (($nr > 0)) { 
                                ...
                                if (isset($_REQUEST['Acceder'])){
                                    ...
                                    if ($row['idtarjeta'] != NULL && $row2['activo']= "si"){
                                        ...
                                        $user = $row['usuario'];
                                        $usuarios = explode("@", $user);
                                        echo "<tr> <td> <input type='radio' name='user' required value=".$row['usuario']."> ".$usuarios[0]."</option> </td>" . " <td> Tarjeta no asignada </td></th>";}
                                    
                                }
                            }
                            }
                            else{
                                echo "<h1 class='form-control'style='color: red;'>Todos los usuarios del departamento tienen asignada tarjeta</h1>";
                                header( "refresh:3;url=alta_prof.php" );
                ...
                <a class="btn btn-primary" href="alta_prof.php">Volver</a>
