        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    ...
                    <h2 id="letra2" class="mx-auto mt-2 mb-5 letradedia">Adjunte CSV con los datos de los alumnos
                    </h2>
                        <form action="importar_csv.php" method="post" enctype="multipart/form-data" id="import_form">
...
<?php 
  ...
  if (isset($_POST['enviar']))
  {
    ...
    $borrar3 = "delete from tabla_nfc_estudiantes";
    $consulta3 = mysqli_query($conn,$borrar3);
    $borrar2 = "delete from tabla_nfc_tarjeta";
    $consulta1 = mysqli_query($conn,$borrar2);   
    ...
    $extension = pathinfo($info->getFilename(), PATHINFO_EXTENSION);
     ...
     if($extension == 'csv')
     {
      ...
      while( ($data = fgetcsv($handle, 1000, ";") ) !== FALSE )
      {
           ...
           $q = "INSERT INTO tabla_nfc_estudiantes (NIE, Unidad) VALUES (
          
          '$data[0]', 
          '$data[1]'
         )";

          $o =  "INSERT INTO alumnos (NIE,Unidad) VALUES (
            '$data[0]', 
            '$data[1]'
           )";
    ...
    $insertar1 =  mysqli_query($conn,$q);
    $insertar = mysqli_query($conn,$o);
