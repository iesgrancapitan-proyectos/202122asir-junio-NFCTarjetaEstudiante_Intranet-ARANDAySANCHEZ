        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    ...
                    <form id="baja" method="POST" action="realizar_baja.php">
                    <select name="motivo" class="form-select" required>
                        <option name="motivo" value="Baja matricula">Baja de matrícula</option>
                ...
                if (isset($_REQUEST['acceder'])){
                    ...
                    $consultanie = "SELECT NIE FROM tabla_nfc_estudiantes WHERE idtarjeta = '$idtarjeta2'";
                    $resultado2 = mysqli_query($conn,$consultanie);
                    ...
                    while($row= mysqli_fetch_array($resultado)){
                        if ($row['Activo'] == 'si'){
                            ...
                            include('conexionbd.php');
                            $tabla_nfc_baja = "INSERT INTO tabla_nfc_baja (IdTarjeta, NIE, causa, fecha) Values ('$idtarjeta2', '$nie3','$motivo', '$mifecha')";
                            ...
                            $tabla_nfc_estudiantes = "UPDATE tabla_nfc_estudiantes SET idtarjeta = NULL where idtarjeta = '$idtarjeta2'";
                            $insertar3 = mysqli_query($conn, $tabla_nfc_estudiantes);
