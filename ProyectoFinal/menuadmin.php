        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    ...
                    <a class="btn btn-primary" href="importar.php">Comienzo curso</a>
                    <a class="btn btn-primary" href="menu_alta.php">Alta tarjeta</a>
                    <a class="btn btn-primary" href="menu_baja.php">Baja tarjeta</a>
