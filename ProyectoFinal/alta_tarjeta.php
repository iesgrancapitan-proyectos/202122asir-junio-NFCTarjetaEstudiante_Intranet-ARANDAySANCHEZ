        ...
        <div id="divcentral" class="container px-4 px-lg-5 d-flex h-100 align-items-center justify-content-center">
            <div class="d-flex justify-content-center">
                <div id="divcentral2" class="text-center">
                    ...
                    <h2 id="letra2" class="mx-auto mt-2 mb-5 letradedia">Pasa la tarjeta o escribe tu codigo de alumno
                    </h2>
                 
                    <form id="acceso" method='POST' action='alta_tarjeta.php'>
                ...
                if (isset($_REQUEST['acceder'])){
                    ...
                    $actualizar = "UPDATE tabla_nfc_estudiantes SET idtarjeta = '$idtarjeta' WHERE NIE = '$nie2'";
